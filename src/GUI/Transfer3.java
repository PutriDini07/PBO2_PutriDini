...
public class Transfer3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(38, 40, 86, 17);
        jPanel1.add(jumtf);
        jumtf.setBounds(181, 78, 135, 20);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Jumlah Transfer :");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(38, 78, 106, 17);
        jPanel1.add(norek);
        norek.setBounds(181, 40, 135, 20);

        benar.setBackground(new java.awt.Color(0, 0, 255));
        benar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        benar.setForeground(new java.awt.Color(255, 255, 255));
        benar.setText("Benar");
        jPanel1.add(benar);
        benar.setBounds(305, 185, 67, 25);

        salah.setBackground(new java.awt.Color(51, 0, 255));
        salah.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        salah.setForeground(new java.awt.Color(255, 255, 255));
        salah.setText("Salah");
        jPanel1.add(salah);
        salah.setBounds(307, 221, 65, 25);
